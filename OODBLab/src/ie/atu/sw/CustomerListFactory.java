...
public class CustomerListFactory {
	...
	public List<Customer> getCustomerList(){
		...
		var c1 = new Customer("C1", "Sean Murphy", CustomerStatus.RECURRING);
		...
		//Build a customer and add to collection
		var c2 = new Customer("C2", "Michael McGrath", CustomerStatus.RECURRING);
		...
		//Build a customer and add to collection
		var c3 = new Customer("C3", "Mary Mannion", CustomerStatus.LEAD);
